...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/jjred.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/megaJump.png", "assets/images/megaJump.png");
			type.set ("assets/images/megaJump.png", Reflect.field (AssetType, "image".toUpperCase ()));
