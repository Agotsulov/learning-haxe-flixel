...
Array< ::String > CompletionHandler_obj::getGlobals( ){
	HX_STACK_FRAME("flixel.system.debug.completion.CompletionHandler","getGlobals",0x3af6d144,"flixel.system.debug.completion.CompletionHandler.getGlobals","flixel/system/debug/completion/CompletionHandler.hx",93,0x776a5e1a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(93)
...
Float CompletionHandler_obj::getCharXPosition( ){
	HX_STACK_FRAME("flixel.system.debug.completion.CompletionHandler","getCharXPosition",0x2e5e3e1f,"flixel.system.debug.completion.CompletionHandler.getCharXPosition","flixel/system/debug/completion/CompletionHandler.hx",98,0x776a5e1a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(99)
...
::String CompletionHandler_obj::getCompletedText( ::String text,::String selectedItem){
	HX_STACK_FRAME("flixel.system.debug.completion.CompletionHandler","getCompletedText",0xf1336e6c,"flixel.system.debug.completion.CompletionHandler.getCompletedText","flixel/system/debug/completion/CompletionHandler.hx",106,0x776a5e1a)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.system.debug.completion.CompletionHandler","completed",0x0b4edb41,"flixel.system.debug.completion.CompletionHandler.completed","flixel/system/debug/completion/CompletionHandler.hx",112,0x776a5e1a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(selectedItem,"selectedItem")
		HX_STACK_LINE(113)
		::openfl::_legacy::text::TextField tmp = this->input;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("flixel.system.debug.completion.CompletionHandler","selectionChanged",0xb4bbcb12,"flixel.system.debug.completion.CompletionHandler.selectionChanged","flixel/system/debug/completion/CompletionHandler.hx",119,0x776a5e1a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(selectedItem,"selectedItem")
	}
return null();
...
{
		HX_STACK_FRAME("flixel.system.debug.completion.CompletionHandler","completionClosed",0xa9f12ef2,"flixel.system.debug.completion.CompletionHandler.completionClosed","flixel/system/debug/completion/CompletionHandler.hx",135,0x776a5e1a)
		HX_STACK_THIS(this)
		HX_STACK_LINE(136)
...
::String CompletionHandler_obj::getPathBeforeDot( ::String text){
	HX_STACK_FRAME("flixel.system.debug.completion.CompletionHandler","getPathBeforeDot",0x9fcc8f79,"flixel.system.debug.completion.CompletionHandler.getPathBeforeDot","flixel/system/debug/completion/CompletionHandler.hx",144,0x776a5e1a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(text,"text")
	HX_STACK_LINE(145)
...
::String CompletionHandler_obj::getWordAfterDot( ::String text){
	HX_STACK_FRAME("flixel.system.debug.completion.CompletionHandler","getWordAfterDot",0x4edfa1a3,"flixel.system.debug.completion.CompletionHandler.getWordAfterDot","flixel/system/debug/completion/CompletionHandler.hx",151,0x776a5e1a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(text,"text")
	HX_STACK_LINE(152)
	::String tmp = text;		HX_STACK_VAR(tmp,"tmp");
...
::String CompletionHandler_obj::getLastWord( ::String text){
	HX_STACK_FRAME("flixel.system.debug.completion.CompletionHandler","getLastWord",0xa19a712c,"flixel.system.debug.completion.CompletionHandler.getLastWord","flixel/system/debug/completion/CompletionHandler.hx",165,0x776a5e1a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(text,"text")
	HX_STACK_LINE(166)
