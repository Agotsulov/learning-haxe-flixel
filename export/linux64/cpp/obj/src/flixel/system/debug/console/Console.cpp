...
{
HX_STACK_FRAME("flixel.system.debug.console.Console","new",0x900a6c8a,"flixel.system.debug.console.Console.new","flixel/system/debug/console/Console.hx",24,0x367943c8)
HX_STACK_THIS(this)
HX_STACK_ARG(completionList,"completionList")
{
	...
	struct _Function_1_1{
		inline static ::haxe::ds::StringMap Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/console/Console.hx",44,0x367943c8)
			{
				HX_STACK_LINE(44)
	...
	struct _Function_1_2{
		inline static ::haxe::ds::StringMap Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/console/Console.hx",40,0x367943c8)
			{
				HX_STACK_LINE(40)
				::haxe::ds::StringMap tmp = ::haxe::ds::StringMap_obj::__new();		HX_STACK_VAR(tmp,"tmp");
				HX_STACK_LINE(40)
	...
	struct _Function_1_3{
		inline static ::haxe::ds::StringMap Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/console/Console.hx",36,0x367943c8)
			{
				HX_STACK_LINE(36)
				::haxe::ds::StringMap tmp = ::haxe::ds::StringMap_obj::__new();		HX_STACK_VAR(tmp,"tmp");
				HX_STACK_LINE(36)
...
{
		HX_STACK_FRAME("flixel.system.debug.console.Console","createInputTextField",0x91c24015,"flixel.system.debug.console.Console.createInputTextField","flixel/system/debug/console/Console.hx",90,0x367943c8)
		HX_STACK_THIS(this)
		HX_STACK_LINE(92)
...
{
		HX_STACK_FRAME("flixel.system.debug.console.Console","registerEventListeners",0x714c11de,"flixel.system.debug.console.Console.registerEventListeners","flixel/system/debug/console/Console.hx",105,0x367943c8)
		HX_STACK_THIS(this)
		HX_STACK_LINE(104)
		...
		Void run(Dynamic _){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","flixel/system/debug/console/Console.hx",116,0x367943c8)
			HX_STACK_ARG(_,"_")
			{
				HX_STACK_LINE(116)
		...
		int __ArgCount() const { return 1; }
		Void run(Dynamic _){
			HX_STACK_FRAME("*","_Function_1_2",0x5200ed38,"*._Function_1_2","flixel/system/debug/console/Console.hx",120,0x367943c8)
			HX_STACK_ARG(_,"_")
			{
				HX_STACK_LINE(120)
...
Void Console_obj::onFocusLost( Dynamic _){
{
		...
		HX_STACK_LINE(192)
		tmp5->debugger->__Field(HX_HCSTRING("onMouseFocusLost","\x76","\x6c","\x77","\xbd"), hx::paccDynamic )();
	}
return null();
}
