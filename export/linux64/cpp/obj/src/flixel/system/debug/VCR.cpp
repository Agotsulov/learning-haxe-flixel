...
{
HX_STACK_FRAME("flixel.system.debug.VCR","new",0x7584fc6f,"flixel.system.debug.VCR.new","flixel/system/debug/VCR.hx",35,0x4ecb3ec2)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.system.debug.VCR","onPause",0xf9cf54e6,"flixel.system.debug.VCR.onPause","flixel/system/debug/VCR.hx",133,0x4ecb3ec2)
		HX_STACK_THIS(this)
		HX_STACK_LINE(134)
...
{
		HX_STACK_FRAME("flixel.system.debug.VCR","onResume",0xb49b1dbd,"flixel.system.debug.VCR.onResume","flixel/system/debug/VCR.hx",143,0x4ecb3ec2)
		HX_STACK_THIS(this)
		HX_STACK_LINE(144)
		::flixel::_system::frontEnds::VCRFrontEnd tmp = ::flixel::FlxG_obj::vcr;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(144)
...
Void VCR_obj::onStep( ){
{
		HX_STACK_FRAME("flixel.system.debug.VCR","onStep",0x2da2775c,"flixel.system.debug.VCR.onStep","flixel/system/debug/VCR.hx",153,0x4ecb3ec2)
		HX_STACK_THIS(this)
		HX_STACK_LINE(154)
		::flixel::_system::frontEnds::VCRFrontEnd tmp = ::flixel::FlxG_obj::vcr;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(154)
