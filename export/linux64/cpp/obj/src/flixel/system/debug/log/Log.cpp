...
{
HX_STACK_FRAME("flixel.system.debug.log.Log","new",0x3aeefde4,"flixel.system.debug.log.Log.new","flixel/system/debug/log/Log.hx",24,0x223ade2e)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(25)
...
{
		HX_STACK_FRAME("flixel.system.debug.log.Log","destroy",0x51a06c7e,"flixel.system.debug.log.Log.destroy","flixel/system/debug/log/Log.hx",44,0x223ade2e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(45)
...
bool FireOnce = __o_FireOnce.Default(false);
	HX_STACK_FRAME("flixel.system.debug.log.Log","add",0x3ae51fa5,"flixel.system.debug.log.Log.add","flixel/system/debug/log/Log.hx",62,0x223ade2e)
	HX_STACK_THIS(this)
...
Void Log_obj::clear( ){
{
		HX_STACK_FRAME("flixel.system.debug.log.Log","clear",0xc2400811,"flixel.system.debug.log.Log.clear","flixel/system/debug/log/Log.hx",136,0x223ade2e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(137)
		::openfl::_legacy::text::TextField tmp = this->_text;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(137)
...
{
		HX_STACK_FRAME("flixel.system.debug.log.Log","updateSize",0x7fdfd666,"flixel.system.debug.log.Log.updateSize","flixel/system/debug/log/Log.hx",148,0x223ade2e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(149)
