...
HX_STACK_ARG(play,"play")
{
	...
	HX_STACK_LINE(40)
	::abilites::megaJump::MegaJump tmp13 = ::abilites::megaJump::MegaJump_obj::__new(((::flixel::FlxObject)(hx::ObjectPtr<OBJ_>(this))),play);		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(40)
	this->ability = tmp13;
	HX_STACK_LINE(43)
...
Void Player_obj::update( Float elapsed){
{
		...
		if ((tmp7)){
			...
			HX_STACK_LINE(85)
			Dynamic tmp11 = hx::SourceInfo(HX_HCSTRING("Player.hx","\xdd","\xc9","\x7f","\xa2"),85,HX_HCSTRING("Player","\x81","\x5f","\x4d","\x6c"),HX_HCSTRING("update","\x09","\x86","\x05","\x87"));		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(85)
...
{
		HX_STACK_FRAME("Player","collide",0x175e7991,"Player.collide","Player.hx",108,0xa27fc9dd)
		HX_STACK_THIS(this)
		HX_STACK_ARG(o1,"o1")
		HX_STACK_ARG(o2,"o2")
		HX_STACK_LINE(110)
...
{
		HX_STACK_FRAME("Player","kill",0x1b5c5bab,"Player.kill","Player.hx",134,0xa27fc9dd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(136)
